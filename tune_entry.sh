...
# nohup bash run_entry_bo_scoot.sh /research/d1/gds/ytyang/kwchen/hf_models/Qwen/Qwen3-32B/models--Qwen--Qwen3-32B/snapshots/9216db5781bf21249d130ec9da846c4624c16137 Qwen3_32B /research/d1/gds/ytyang/kwchen/hetero_rollout/datasets/gpqa_diamond_train_processed.json gpqa_diamond 198 198 8 A800 > run_entry_bo_scoot_qwen3_32b.log 2>&1 &
